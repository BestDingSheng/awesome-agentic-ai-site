...
> [繁体中文](/zh-tw/stages/08-agent-interfaces/) | **简体中文** | [English](/en/stages/08-agent-interfaces/)
...
**为什么真实能力 ≠ 数据**（呼应 [Stage 7 reward-hacking 警告](/stages/07-multi-agent-production/#-agent-benchmark-landscape2026-05-最新--reward-hacking-警告)）：
...
→ **呼应 [Stage 7 reward-hacking 警告](/stages/07-multi-agent-production/#-agent-benchmark-landscape2026-05-最新--reward-hacking-警告)**：课程始终强调“**不要盲目相信智能体**”的规范——Stage 7 讲评估规范，Stage 8 讲运行时规范。
...
如果都可以 → 你已完成课程主干。选择一个[特化分支](/#️-学习地图与两条学习路径)，或继续看下一节 下一个前沿。
