...
> **繁體中文** | [English](/stages/03-tool-use-and-hello-agent-en/)

⏱ **時間估算**：2-3 週（約 10-20 小時）

> 💡 用語密集（agent / tool use / function calling / ReAct / structured output⋯）→ 翻 [`resources/glossary.md` §2](/resources/glossary/#2-agent--工具使用)。
...
> 💡 詳細 cheatsheet 看 [`resources/schema-design-cheatsheet.md`](/resources/schema-design-cheatsheet/)——5 條黃金規則 + 5 個常見 anti-pattern。
...
如果可以 → 進 [Stage 4 — Agent Frameworks](/stages/04-agent-frameworks/)。
