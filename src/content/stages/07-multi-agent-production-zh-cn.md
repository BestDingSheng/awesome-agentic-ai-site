...
> [繁體中文](/stages/07-multi-agent-production/) | **简体中文** | [English](/stages/07-multi-agent-production-en/)

⏱ **时间估算**：2-4 周（约 15-30 小时）

> 💡 用语密度高（multi-agent / handoff / eval / observability / guardrails⋯）→ 翻 [`resources/glossary.zh-CN.md`](/resources/glossary-zh-cn/#4-multi-agent)。
