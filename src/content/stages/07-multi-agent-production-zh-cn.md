...
description: "这一关要做的是 Agent Production Engineering（Agent 上线工程）：为 Agent 搭好能安全工作的 Harness，设计会根据证据继续或停止的 Loop，再用 Workflow Graph 排好完整路线。它不只要“偶尔成功”，还要能被看见、被检查，出错时也能安全停下来。"
section: "Stage"
