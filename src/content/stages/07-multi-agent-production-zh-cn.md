---
title: "Stage 7 — Agent 上线工程：可测、可看、可停、可恢复"
description: "这一关教你把 AI 帮手交给别人使用。它不能只在你面前偶尔成功；你还要能检查它、看见它做过什么、在危险动作前停下，并在出错后安全继续。"
section: "Stage"
...
- [Stage 4](/stages/04-agent-frameworks/)：知道 Agent、Tool 与 Workflow 是什么。
- [Stage 5](/stages/05-claude-code-ecosystem/)：看过工具权限、Subagent 与开发流程。
- [Stage 6](/stages/06-memory-rag/)：知道 Context、RAG 与 Memory 不一样。
...
![完整 Eval Case 包含 Input、Initial State、Success Criteria、Forbidden Actions、Optional Reference Answer、Grader 与 Case Metadata；Input 只是其中一格](/upstream/resources/diagrams/eval-case-anatomy.zh-Hans.png)
