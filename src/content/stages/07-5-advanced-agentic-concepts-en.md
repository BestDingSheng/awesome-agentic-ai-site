---
title: "Stage 7.5 — Advanced Agentic Concepts Map"
description: "⏱ Estimated Time: 1 week (about 5 hours — no coding, just reading resources to build the concept map)"
section: "Stage"
...
Below shows how the 5 principles act on [Stage 7's 8 core Harness components](/en/stages/07-multi-agent-production/#the-8-core-components-of-a-harness) (✓ = applies, ✓★ = primary lever):
...
> 📚 **Want to go deeper on eval rigor**: [Establishing Best Practices for Building Rigorous Agentic Benchmarks](https://arxiv.org/abs/2507.02825) is a systematic catalog; for the production reward-hacking warning see the Berkeley section in [Stage 7 Benchmark Landscape](/en/stages/07-multi-agent-production/) + the pass^k design of τ-bench ([sierra-research/tau2-bench](https://github.com/sierra-research/tau2-bench)).
...
> 📌 **Claude Fable 5 (2026-06-09; suspended 2026-06-12, restored 2026-07-01)**: Anthropic's Mythos-class **Claude Fable 5** (`claude-fable-5`, positioned above the Opus class) shipped as the widely-available highest-capability member, alongside a limited-availability Claude Mythos 5 (`claude-mythos-5`). It was suspended 2026-06-12 by a US export-control directive, but the controls were lifted 2026-06-30 and [Fable 5 was redeployed globally 2026-07-01](https://www.anthropic.com/news/redeploying-fable-5) with a new safety classifier. Fable 5 is again the highest Claude tier; Opus 4.8 is the Opus-class flagship, and **Dynamic Workflows remains an Opus 4.8 feature**, not re-attributed to Fable 5.
...
> 🛠️ **Want to actually write SKILL.md / CLAUDE.md now?** The 4 implementation prompts (audit existing / generate new) have been **moved to [Stage 5](/en/stages/05-claude-code-ecosystem/)**, which is where readers should do the real hands-on writing:
> - [Stage 5.1  CLAUDE.md design prompts](/en/stages/05-claude-code-ecosystem/#-claudemd-design-prompts-using-the-5-principles)
> - [Stage 5.3  SKILL.md design prompts](/en/stages/05-claude-code-ecosystem/#-skillmd-design-prompts-including-skill-creator-as-the-alternative)
...
→ **Suggested usage**: run this quiz after learning the 5 principles above to confirm that you actually absorbed the concepts. For the real write / audit prompts, go back to [Stage 5](/en/stages/05-claude-code-ecosystem/).
...
4. **Encode into Skills + CLAUDE.md**: use the 4 prompts in Stage 5 — CLAUDE.md audit / generate ([Stage 5.1](/en/stages/05-claude-code-ecosystem/#51--claude-code-basics)) + SKILL.md audit / generate ([Stage 5.3](/en/stages/05-claude-code-ecosystem/#53--skills-claude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem)).
