...
[Open the full instructions and checks](/en). Start with only a few sentences to avoid unnecessary API costs.
...
[Open the full instructions and checks](/en). Exercise data must not contain secrets or personal information.
...
[Open the full instructions and checks](/en). Do not memorize a “standard size”; begin with document structure and test results.
...
[Open the full instructions and checks](/en). Start with a small dataset; “the program runs” does not mean the answer is correct.
...
[Open the full instructions and checks](/en). Save only data needed to finish a task and provide ways to view, change, and delete it.
...
![RAG prepares data, then retrieves candidates, organizes evidence, and answers with sources](/upstream/resources/diagrams/rag-pipeline-overview.en.png)
