...
> 🚪 **Entry condition and the two tracks** (this stage and [Stage 8 — Agent Interfaces](/en/stages/08-agent-interfaces/) are the curriculum's two shared hubs):
...
The rest of Stage 5 is about Claude Code specifically. For a full comparison of all 5 agent paradigms → [`resources/agent-paradigms.en.md`](/en/resources/agent-paradigms/) (Claude Code is Type 1 IDE-coupled + Type 2 Terminal pair-programmer).
