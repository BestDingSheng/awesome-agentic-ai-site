...
> 📋 **學完進階概念回頭看 synthesis** → [Stage 5 §🗺️ 7-Layer Architecture Map](/zh-tw/stages/05-claude-code-ecosystem/#-7-layer-architecture-map先看這張圖再讀-51-56)（Claude Code 7 個 primitive + 3 個工程學 discipline 整合圖）
