---
title: "Stage 8 — Agent 操作介面（Agent Interfaces）：Browser Use · Computer Use · Sandbox"
description: "前面的 Stage 教 agent「想什麼、叫什麼工具」。這一關教另一件事：它要從哪一扇門做事。門選得越大，能碰的東西越多，風險也越大。所以第一步不是找最強產品，而是選最小、最好檢查的門。"
section: "Stage"
...
沿主線讀到這裡，可以先回看[上一關：Stage 7.5 進階 Agentic 概念](/zh-tw/stages/07-5-advanced-agentic-concepts/)。你只要懂 [Stage 03](/zh-tw/stages/03-tool-use-and-hello-agent/) 的「模型提出工具呼叫 → 程式執行 → 結果回給模型」就能開始。Track A 可以只做第一題；Track B 再做第二題。
...
![Search、Browser Use、Computer Use 與 Sandbox 的選擇順序](/upstream/resources/diagrams/interface-choice-map.png)
...
![Agent 動作前後的四道安全檢查](/upstream/resources/diagrams/agent-guardrail-patterns.png)
...
做到這裡，你已完成主幹。下一步挑一條專門路徑：[研究人員](/zh-tw/branches/for-researcher/)、[開發者](/zh-tw/branches/for-developer/)、[教師](/zh-tw/branches/for-teacher/)、[知識工作者](/zh-tw/branches/for-knowledge-worker/)或[日常使用者](/zh-tw/branches/for-everyday-users/)。
