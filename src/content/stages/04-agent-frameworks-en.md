...
> 💡 Unfamiliar with terms like `framework`, `supervisor`, `worker`, `handoff`? → Check [`resources/glossary.md`](/en/resources/glossary/).
...
> 🔑 **Key Terms**: See [`resources/glossary.md`](/en/resources/glossary/) (2 & 4 cover terms like `framework`, `agent loop`, `handoff`, `supervisor`).
