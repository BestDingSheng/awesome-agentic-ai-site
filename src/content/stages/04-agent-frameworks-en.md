...
Once you have done all of this, move on to [Stage 5 — Claude Code Ecosystem](/en/stages/05-claude-code-ecosystem/). If the four cells are still unclear, return to the choice map above; you do not need to reread the 19-row table.
