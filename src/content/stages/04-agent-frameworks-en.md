...
description: "In Stage 3, you wrote a tool loop yourself. This stage has a simple purpose: see which repeated tasks can be handed to an existing toolkit, and learn when not to make the system more complex."
section: "Stage"
