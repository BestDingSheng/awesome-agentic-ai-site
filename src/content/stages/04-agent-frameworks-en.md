---
title: "Stage 4 — Workflow Graphs & Agent Frameworks"
description: "In Stage 3, you wrote an Agent Loop yourself. This stage first turns multi-step work into a Workflow Graph, then chooses a Framework to help connect it. Understand the work map first, then choose the toolbox, so you do n"
section: "Stage"
...
![Agent-system choice map: first distinguish whether the program or an Agent chooses the next step, then whether one or multiple Agents are needed, and finally choose the simplest shape that completes the task](/upstream/resources/diagrams/agent-framework-choice-map.en.png)
...
- A Claude Code subagent is another runtime-built-in route: configuration files isolate context and tools, so you do not need to write Python orchestration yourself. The full comparison is in [Stage 5.5](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature).
...
1. [Exercise 1 README](/en)
2. [Exercise 2 README](/en)
3. [Exercise 3 README](/en)
4. [Exercise 4 README](/en)
5. [Exercise 5 README](/en)
...
Once you have done all of this, move on to [Stage 5 — Claude Code Ecosystem](/en/stages/05-claude-code-ecosystem/). If the four cells are still unclear, return to the choice map above; you do not need to reread the 18-row table.
