---
title: "Stage 6 — Memory · RAG · Context Engineering"
description: "⏱ **時間估算**：2 週（約 10 小時）"
section: "Stage"
...
| 3 | **Harness Engineering** | 把多個 LLM call 包成 production runtime | [Stage 7 §Harness Engineering](/zh-tw/stages/07-multi-agent-production/#-harness-engineering--production-agent-runtime-的工程學--本-stage-核心概念) |
...
| **Procedural memory** | 怎麼做事的程式 / skill | tool definitions、[Skills（Stage 5.3）](/zh-tw/stages/05-claude-code-ecosystem/#53--skills--可重複使用的-prompt--instruction-包) |
...
| **Agentic RAG**（一般概念）| retrieval 當 tool、agent 自己決定查幾次 / 怎麼查 | LlamaIndex / LangGraph、[Stage 7](/zh-tw/stages/07-multi-agent-production/) 主場 |
