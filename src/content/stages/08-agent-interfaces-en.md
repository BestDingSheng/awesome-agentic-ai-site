...
**Why real ability ≠ the numbers** (echoing the [reward-hacking warning in Stage 7](/zh-tw/stages/07-multi-agent-production/#-agent-benchmark-landscape2026-05--reward-hacking-warnings)):
...
→ **Echoing the [reward-hacking warning in Stage 7](/zh-tw/stages/07-multi-agent-production/#-agent-benchmark-landscape2026-05--reward-hacking-warnings)**: This curriculum consistently teaches the discipline of "**don't blindly trust the agent**." Stage 7 talked about evaluation discipline, Stage 8 talks about runtime discipline.
...
If you can do all of this → you've completed the main curriculum. Pick a [specialized branch](/en#-learning-map-and-two-tracks), or see below for the next frontier.
