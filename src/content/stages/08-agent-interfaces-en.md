---
title: "Stage 8 — Agent Interfaces: Browser Use · Computer Use · Sandbox"
description: "Earlier stages teach an agent what to think about and which tool to request. This stage teaches a different question: which door should it use to do the work? A larger door reaches more things and creates more risk. Star"
section: "Stage"
...
If you followed the main path, you can first revisit the [previous stage: Stage 7.5 Advanced Agentic Concepts](/en/stages/07-5-advanced-agentic-concepts/). You only need the Stage 03 loop: model proposes a tool call → code executes it → result returns to the model. Track A may stop after Exercise 1; Track B can continue to Exercise 2.
...
![How to choose Search, Browser Use, Computer Use, or Sandbox](/upstream/resources/diagrams/interface-choice-map.en.png)
...
![Four safety checks around agent actions](/upstream/resources/diagrams/agent-guardrail-patterns.en.png)
...
You have now completed the main path. Choose a specialist path: [researcher](/en/branches/for-researcher/), [developer](/en/branches/for-developer/), [teacher](/en/branches/for-teacher/), [knowledge worker](/en/branches/for-knowledge-worker/), or [everyday user](/en/branches/for-everyday-users/).
