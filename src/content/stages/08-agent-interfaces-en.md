---
title: "Stage 8 — Agent Interfaces: Computer Use, Browser Use, & Code Sandbox"
description: "⏱ Estimated Time: 2-3 weeks (approx. 12-20 hours)"
section: "Stage"
...
> 🔑 **Key Terms**: See explanations within this chapter and in the main [`resources/glossary.en.md`](/en/resources/glossary/).
...
**Why real ability ≠ the numbers** (echoing the [reward-hacking warning in Stage 7](/en/stages/07-multi-agent-production/#-agent-benchmark-landscape-how-to-read-it-not-just-the-leaderboard---reward-hacking-warning)):
...
→ **Echoing the [reward-hacking warning in Stage 7](/en/stages/07-multi-agent-production/#-agent-benchmark-landscape-how-to-read-it-not-just-the-leaderboard---reward-hacking-warning)**: This curriculum consistently teaches the discipline of "**don't blindly trust the agent**." Stage 7 talked about evaluation discipline, Stage 8 talks about runtime discipline.
...
If you can do all of this → you've completed the main curriculum. Pick a [specialized branch](/en#-learning-map-two-tracks), or see below for the next frontier.
