...
description: "這一關要做的是 Agent Production Engineering（Agent 上線工程）：替 Agent 蓋好能安全工作的 Harness，設計會依證據繼續或停止的 Loop，再用 Workflow Graph 排好完整路線。它不只要「偶爾成功」，還要能被看見、被檢查，出錯時也能安全停下來。"
section: "Stage"
