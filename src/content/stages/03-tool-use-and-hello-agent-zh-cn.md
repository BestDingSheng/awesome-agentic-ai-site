...
> [繁體中文](/stages/03-tool-use-and-hello-agent/) | **简体中文** | [English](/stages/03-tool-use-and-hello-agent-en/)

⏱ **时间估算**：2-3 周（约 10-20 小时）

> 💡 用语密集（agent / tool use / function calling / ReAct / structured output⋯）→ 翻 [`resources/glossary.zh-CN.md` §2](/resources/glossary-zh-cn/#2-agent--工具使用)。
...
> 💡 详细 cheatsheet 看 [`resources/schema-design-cheatsheet.zh-CN.md`](/resources/schema-design-cheatsheet-zh-cn/)——5 条黄金规则 + 5 个常见 anti-pattern。
...
如果可以 → 进 [Stage 4 — Agent Frameworks](/stages/04-agent-frameworks-zh-cn/)。
