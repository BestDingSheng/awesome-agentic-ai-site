...
Allow about one week and 5–8 hours. You should be able to run a Python script and understand HTTP/REST at a basic level. An API key is not required for the main path because the exercises use local Ollama. If Python or the command line is still unfamiliar, return to [Stage 0](/en/stages/00-foundations/).
...
If yes, continue to [Stage 2 — Prompt Engineering](/en/stages/02-prompt-engineering/). If not, rerun Exercises 1–3 on Path A, then open the reading or troubleshooting sections as needed.

---

> ✅ **Stage 1 complete?** [**Stage 2 — Prompt Engineering**](/en/stages/02-prompt-engineering/) will help you write reusable structured prompts and quantify improvements with evals.
