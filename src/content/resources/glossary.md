...
LLM 一次能「看」多少 token。**2026 frontier**：Claude Sonnet 4.6 / Opus 4.8 1M、GPT-5.6（preview）~400k、Gemini 3.5 Flash 1M（Pro 系列上看 2M）、xAI Grok 4.3 1M、Mistral Medium 3.5 256k。**不是越大越好**——超過某個長度後 LLM 會「在中間遺漏」（Lost in the Middle）。
