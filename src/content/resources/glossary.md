...
description: "GPT、Claude、Gemini 這類「給文字、回文字」的模型。本身是純函式：input prompt → output text。它**不會自己上網、不會記住上次對話**——這些都要外接系統來做。"
section: "Resource"
...
📍 基本版 concept + 路由：[Stage 3 §反思](/zh-tw/stages/03-tool-use-and-hello-agent/#-反思reflexion--self-refine-概念--路由)
📍 帶持久記憶的完整版：[Stage 6 §進階：帶持久記憶的 Reflexion 完整版](/zh-tw/stages/06-memory-rag/#-進階帶持久記憶的-reflexion-完整版--track-b-選讀)
...
📍 詳細：[Stage 5.3](/zh-tw/stages/05-claude-code-ecosystem/#53--skillsclaude-code-的行為層)
...
📍 **Discipline 級概念**（**8 元件** / prompt→context→harness lineage / framework vs harness）：[Stage 7 §Harness Engineering](/zh-tw/stages/07-multi-agent-production/#-harness-engineering--production-agent-runtime-的工程學--本-stage-核心概念)
...
- 看 [Stage 5.2 — MCP](/zh-tw/stages/05-claude-code-ecosystem/#52--mcpmodel-context-protocol-基礎) / [5.3 — Skills](/zh-tw/stages/05-claude-code-ecosystem/#53--skillsclaude-code-的行為層) / [5.4 — Plugins](/zh-tw/stages/05-claude-code-ecosystem/#54--plugins-與-marketplaces) 的內文
- 看 [Stage 1](/zh-tw/stages/01-llm-basics/) / [Stage 6](/zh-tw/stages/06-memory-rag/) / [Stage 7](/zh-tw/stages/07-multi-agent-production/) 的延伸閱讀清單
