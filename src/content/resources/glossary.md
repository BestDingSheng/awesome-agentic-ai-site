...
📍 詳細 + 練習：[Stage 3 §練習 7](/zh-tw/stages/03-tool-use-and-hello-agent/#練習-7反思迴圈reflexion-模式--track-b-必看)
...
📍 詳細解剖 + source-reading 練習：[Stage 5 §5.6 Harness Internals](/zh-tw/stages/05-claude-code-ecosystem/#56--harness-internalsagent-runtime-的內部結構-track-b-必看)
📍 production 視角：[Stage 7](/zh-tw/stages/07-multi-agent-production/) 必修閱讀
