...
> 这份文档写给“想学 AI agent，但还没写过 code”的人。已经熟 Python / git / CLI 的开发者，可以直接跳 [Stage 1](/stages/01-llm-basics/)。
...
→ 详细比较 → [`branches/for-developer.zh-Hans.md`](/branches/for-developer/)
...
→ 想看 7 个 CLI 完整比较 → [`cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/)
...
- **Ollama 本地模型**：不用 API key。走本地路线请看 [Cookbook Recipe 6](/resources/cookbook/#6-本地-llm--cli-agent-快速-walkthrough)。
...
> 想看更完整的 Skill 设计：看 [Stage 5.3 — Skills](/stages/05-claude-code-ecosystem/#53--skillsclaude-code-的行为层-claude-code-生态最关键的一层)。
> 想看可以照做的示例：看 [Cookbook](/resources/cookbook/)。
...
| 你现在的状态 | 下一步 |
|---|---|
| 想正式理解 LLM、API、token | [Stage 1 — LLM 基础](/stages/01-llm-basics/) |
| 想直接挑身份分支 | [日常用户](/branches/for-everyday-users/) / [教师](/branches/for-teacher/) / [知识工作者](/branches/for-knowledge-worker/) / [研究者](/branches/for-researcher/) / [开发者](/branches/for-developer/) |
| 想看 Claude Code 完整生态 | [Stage 5 — Claude Code 生态](/stages/05-claude-code-ecosystem/) |
| 想本地 LLM、不用云端 key | [Cookbook Recipe 6](/resources/cookbook/#6-本地-llm--cli-agent-快速-walkthrough) |
| 想比较 CLI agent | [CLI Agents 比较指南](/resources/cli-agents-guide/) |
| 不懂某个用词 | [Glossary](/resources/glossary/) |
