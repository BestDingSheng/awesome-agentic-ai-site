...
sourceUrl: "https://github.com/WenyuChiou/awesome-agentic-ai-zh/blob/main/resources/schema-design-cheatsheet.md"
...
- [Stage 3 — Tool Use & Agent 入門](/zh-tw/stages/03-tool-use-and-hello-agent/) — 主要動手練習
- [Stage 5.2 — MCP 基礎](/zh-tw/stages/05-claude-code-ecosystem/#52--mcpmodel-context-protocol-基礎) — MCP server 的 tool schema（跟 function calling schema 結構幾乎相同）
