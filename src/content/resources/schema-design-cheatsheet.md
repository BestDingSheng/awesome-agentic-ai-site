...
description: "模型會一起看 tool name、description、schema 與對話內容，決定要不要提出 Tool Call。所以要："
section: "Resource"
...
> [Stage 3 — 工具使用與第一個 Agent Loop](/zh-tw/stages/03-tool-use-and-hello-agent/) 的補充參考。寫 tool / function schema 時的 5 條黃金規則 + 5 個 anti-pattern。
...
- [Stage 3 — 工具使用與第一個 Agent Loop](/zh-tw/stages/03-tool-use-and-hello-agent/) — 主要動手練習
- [Stage 5.2 — MCP 基礎](/zh-tw/stages/05-claude-code-ecosystem/#52--mcpmodel-context-protocol-基礎) — MCP server 也使用 tool schema，但 host、權限與協定層不同
