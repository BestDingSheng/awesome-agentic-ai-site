---
title: "Function Schema 設計 Cheatsheet"
description: "LLM 怎麼用你的 tool **80% 取決於 schema 寫得好不好**——schema 模糊，再強的模型也會選錯、傳錯。"
section: "Resource"
...
> **繁體中文** | [简体中文](/resources/schema-design-cheatsheet-zh-cn/) | [English](/resources/schema-design-cheatsheet-en/)

> [Stage 3 — Tool Use & Agent 入門](/stages/03-tool-use-and-hello-agent/) 的補充參考。寫 tool / function schema 時的 5 條黃金規則 + 5 個 anti-pattern。
...
- [Stage 3 — Tool Use & Agent 入門](/stages/03-tool-use-and-hello-agent/) — 主要動手練習
- [Stage 5.2 — MCP 基礎](/stages/05-claude-code-ecosystem/#52--mcpmodel-context-protocol-基礎) — MCP server 的 tool schema（跟 function calling schema 結構幾乎相同）
