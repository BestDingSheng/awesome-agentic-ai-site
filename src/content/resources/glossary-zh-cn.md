...
📍 详细：[Track A A1](/tracks/cli-a1-cli-intro/)、[`resources/cli-agents-guide.zh-CN.md`](/resources/cli-agents-guide/)
...
- 看 [Stage 1](/stages/01-llm-basics/) / [Stage 6](/stages/06-memory-rag/) / [Stage 7](/stages/07-multi-agent-production/) 的延伸阅读清单
