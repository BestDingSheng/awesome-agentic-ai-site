---
title: "Cookbook — Turn concepts into real results"
description: "You do not need to read this Cookbook in one sitting. Pick one result you want, copy its first action, and open the details only when you need the remaining steps."
section: "Resource"
...
If these terms are new to you, first return to [Stage 5: Claude Code Ecosystem](/en/stages/05-claude-code-ecosystem/). To compare OpenRouter, Pi, OpenCode, and Ollama, open the [Complete CLI Agent Guide](/en/resources/cli-agents-guide/).
...
- The [Complete CLI Agent Guide](/en/resources/cli-agents-guide/) explains when to choose Claude Code, OpenCode, Pi, Aider, OpenRouter, or a local runtime.
...
Then return to [Stage 5](/en/stages/05-claude-code-ecosystem/) to choose the next skill. To find more tools, open the [MCP／Skills Catalog](/en/resources/mcp-skills-catalog/).
