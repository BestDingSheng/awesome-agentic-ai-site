...
> This guide is for people who want to learn AI agents but have not written code before. If you already know Python, git, and the CLI, you can skip to [Stage 1](/en/stages/01-llm-basics/).
...
→ Detailed comparison → [`branches/for-developer.en.md`](/en/branches/for-developer/)
...
- **Ollama local models**: no API key needed. For the local path, see [Cookbook Recipe 6](/en/resources/cookbook/#6-local-llm--cli-agent-quick-walkthrough).
...
|---|---|
| You want to understand LLMs, APIs, and tokens | [Stage 1 — LLM Basics](/en/stages/01-llm-basics/) |
| You want to pick a role-based branch | [Everyday users](/en/branches/for-everyday-users/) / [Teachers](/en/branches/for-teacher/) / [Knowledge workers](/en/branches/for-knowledge-worker/) / [Researchers](/en/branches/for-researcher/) / [Developers](/en/branches/for-developer/) |
| You want the full Claude Code ecosystem | [Stage 5 — Claude Code Ecosystem](/en/stages/05-claude-code-ecosystem/) |
| You want local LLMs without a cloud key | [Cookbook Recipe 6](/en/resources/cookbook/#6-local-llm--cli-agent-quick-walkthrough) |
| You want to compare CLI agents | [CLI Agents Comparison Guide](/en/resources/cli-agents-guide/) |
| A term is unclear | [Glossary](/en/resources/glossary/) |
