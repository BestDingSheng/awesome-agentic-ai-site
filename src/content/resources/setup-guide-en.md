---
title: "🚀 From Zero — Setup Guide for People Without a Development Background"
description: "This page does not ask you to install every tool. Just choose one door first and complete one small result."
section: "Resource"
...
---
> [繁體中文](/zh-tw/resources/setup-guide/) | [简体中文](/resources/setup-guide/) | **English**

# 🚀 From Zero — Setup Guide for People Without a Development Background

> [← Back to the main roadmap README](/en)
...
Already comfortable with Python, Git, and the terminal, and know how to protect an **API Key**? Go straight to [Stage 1](/en/stages/01-llm-basics/).
...
| Have AI assist while you write code | **IDE Assistant**: lives inside the editor | Start with the [developer branch](/en/branches/for-developer/) |
| Let an Agent read and edit files and run commands in a specified folder | **CLI Agent**: works in the terminal | Start with the [CLI Agents guide](/en/resources/cli-agents-guide/) |
...
Local inference has no provider model API bill, but you remain responsible for hardware, electricity, download time, device security, files, and logs. For the complete path, see the [Cookbook local LLM walkthrough](/en/resources/cookbook/#6-local-llm--cli-agent-quick-walkthrough).
...
For fuller responsibility boundaries, see [Stage 5.3 — Skills](/en/stages/05-claude-code-ecosystem/#53--skills-on-demand-procedure-cards); for more examples, see the [Cookbook](/en/resources/cookbook/).
...
|---|---|
| Understand models, Tokens, Context Windows, and APIs | [Stage 1 — LLM Basics](/en/stages/01-llm-basics/) |
| Learn Prompt directly | [Stage 2 — Prompt Engineering](/en/stages/02-prompt-engineering/) |
| Work with a CLI Agent | [Track A1 — CLI Basics](/en/tracks/cli-a1-cli-intro/) |
| Understand Claude Code, MCP, Skills, Plugins, and Subagents | [Stage 5 — Claude Code Ecosystem](/en/stages/05-claude-code-ecosystem/) |
| Use local models | [Cookbook: local LLM walkthrough](/en/resources/cookbook/#6-local-llm--cli-agent-quick-walkthrough) |
| Still cannot distinguish OpenRouter, Ollama, OpenCode, or Pi | [Glossary: distinguish five tool identities](/en/resources/glossary/#-separate-five-tool-identities-first) |
