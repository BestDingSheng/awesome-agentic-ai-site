---
title: "🚀 从零开始 — 给没有开发背景的设置指南"
description: "按「想花多少时间 setup」由浅到深排序。**完全没接触过 LLM 直接从 1️⃣ 开始就好**。"
section: "Resource"
...
language: "zh-tw"
languageLabel: "繁體中文"
baseSlug: "setup-guide-zh-hans"
---> [繁體中文](/zh-tw/resources/setup-guide/) | **简体中文** | [English](/en/resources/setup-guide/)
...
> 这份文档写给“想学 AI agent，但还没写过 code”的人。已经熟 Python / git / CLI 的开发者，可以直接跳 [Stage 1](/zh-tw/stages/01-llm-basics-zh-hans/)。
...
→ 详细比较 → [`branches/for-developer.zh-Hans.md`](/zh-tw/branches/for-developer-zh-hans/)
...
→ 想看 7 个 CLI 完整比较 → [`cli-agents-guide.zh-Hans.md`](/zh-tw/resources/cli-agents-guide-zh-hans/)
...
- **Ollama 本地模型**：不用 API key。走本地路线请看 [Cookbook Recipe 6](/zh-tw/resources/cookbook-zh-hans/#6-本地-llm--cli-agent-快速-walkthrough)。
...
> 想看更完整的 Skill 设计：看 [Stage 5.3 — Skills](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#53--skillsclaude-code-的行为层)。
> 想看可以照做的示例：看 [Cookbook](/zh-tw/resources/cookbook-zh-hans/)。
...
| 你现在的状态 | 下一步 |
|---|---|
| 想正式理解 LLM、API、token | [Stage 1 — LLM 基础](/zh-tw/stages/01-llm-basics-zh-hans/) |
| 想直接挑身份分支 | [日常用户](/zh-tw/branches/for-everyday-users-zh-hans/) / [教师](/zh-tw/branches/for-teacher-zh-hans/) / [知识工作者](/zh-tw/branches/for-knowledge-worker-zh-hans/) / [研究者](/zh-tw/branches/for-researcher-zh-hans/) / [开发者](/zh-tw/branches/for-developer-zh-hans/) |
| 想看 Claude Code 完整生态 | [Stage 5 — Claude Code 生态](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/) |
| 想本地 LLM、不用云端 key | [Cookbook Recipe 6](/zh-tw/resources/cookbook-zh-hans/#6-本地-llm--cli-agent-快速-walkthrough) |
| 想比较 CLI agent | [CLI Agents 比较指南](/zh-tw/resources/cli-agents-guide-zh-hans/) |
| 不懂某个用词 | [Glossary](/zh-tw/resources/glossary-zh-hans/) |
