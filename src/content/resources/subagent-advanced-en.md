---
title: "Advanced subagent usage — Description Patterns / Composition / Debug"
description: "Three independent advanced topics. Jump to the section you need:"
section: "Resource"
...
> [繁體中文](/zh-tw/resources/subagent-advanced/) | [简体中文](/resources/subagent-advanced/) | **English**

> 📋 **Who this is for**: You already know how to use built-in subagents (you have gone through [Stage 5.5](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature) + the [cookbook](/en/resources/subagent-cookbook/)), and you are ready to: (1) **write your own** subagent, (2) **compose multiple** subagents, or (3) **debug** a broken subagent.
>
...
> 📌 **Different angle from [Stage 5.5 §Clarifying 5 Gotchas](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature)**:
...
- **More dispatch recipes** → [`subagent-cookbook.en.md`](/en/resources/subagent-cookbook/) (15 copy-paste dispatch prompts)
- **Understand how subagents relate to skills / MCP** → [Stage 5.5](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature)
- **Run multi-agent coordination** (Pattern B) → the [agent-collab-skills](https://github.com/WenyuChiou/agent-collab-skills) plugin
- **Vocabulary quick lookup** → [`glossary.en.md` § 5. Claude Code ecosystem](/en/resources/glossary/#5-claude-code-ecosystem)
