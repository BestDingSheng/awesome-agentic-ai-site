...
> **繁體中文** | [简体中文](/resources/mcp-skills-catalog-zh-cn/) | [English](/resources/mcp-skills-catalog-en/)
...
- **想看 MCP / Skills / Plugins 是什麼**：先看 [README 三個核心用語](/#三個核心用語mcp--skills--plugins)，再看 [Stage 5 — Claude Code 生態系](/stages/05-claude-code-ecosystem/)
- **想看 動手練習 怎麼裝、怎麼測**：看 [Stage 5.2 (MCP)](/stages/05-claude-code-ecosystem/#52--mcpmodel-context-protocol-基礎) 跟 [Stage 5.3 (Skills)](/stages/05-claude-code-ecosystem/#53--skillsclaude-code-的行為層)
