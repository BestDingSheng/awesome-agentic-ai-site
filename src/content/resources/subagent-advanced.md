---
title: "Subagent 進階使用 — Description 寫法 / Composition / Debug"
description: "| 你的問題 | 看哪節 | |---|---| | 寫了一個 subagent，但 Claude 從來不主動派它——為什麼？ | §1 Description 怎麼寫才會被主 session 主動 spawn | | 想跑 2-3 個 subagent 串成 pipeline / parallel——怎麼設計？ | §2 Composition pattern 怎麼設計 | | Subagent 跑壞 / 報錯 / 行為跟設定的不一樣"
section: "Resource"
...
> **繁體中文** | [简体中文](/resources/subagent-advanced/) | [English](/en/resources/subagent-advanced/)

> 📋 **這份是給誰看的**：你已經會用內建 subagent（[Stage 5.5](/zh-tw/stages/05-claude-code-ecosystem/#55--subagentsclaude-code-原生-multi-agent-機制-2025-新功能) + [cookbook](/zh-tw/resources/subagent-cookbook/) 走完了），準備：(1) **自己寫一個** subagent、(2) **組合多個** subagent、或 (3) **debug** 跑壞的 subagent。
>
...
![Subagent Composition — 3 種組合 Pattern](/upstream/resources/diagrams/subagent-composition-patterns.png)
...
> 📌 **跟 [Stage 5.5 §易混淆 5 條 Gotcha](/zh-tw/stages/05-claude-code-ecosystem/#55--subagentsclaude-code-原生-multi-agent-機制-2025-新功能) 角度不同**——
...
- **想看更多 dispatch recipe** → [`subagent-cookbook.md`](/zh-tw/resources/subagent-cookbook/)（15 個複製即用的派遣 prompt）
- **想理解 subagent 跟 skill / MCP 的層次關係** → [Stage 5.5](/zh-tw/stages/05-claude-code-ecosystem/#55--subagentsclaude-code-原生-multi-agent-機制-2025-新功能)
- **想跑 multi-agent coordination**（Pattern B）→ [agent-collab-skills](https://github.com/WenyuChiou/agent-collab-skills) plugin
- **詞彙快查** → [`glossary.md` § 5. Claude Code 生態](/zh-tw/resources/glossary/#subagent子-agent)
