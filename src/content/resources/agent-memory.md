---
title: "Agent Memory：只記值得記、允許記、能刪掉的事"
description: "Agent Memory（代理記憶）像一本有管理規則的筆記本。它不是把所有聊天偷偷存起來；它只保存之後真的需要、使用者允許，而且可以查看、修改與刪除的內容。"
section: "Resource"
sourcePath: "resources/agent-memory.md"
sourceUrl: "https://github.com/BestDingSheng/awesome-agentic-ai-zh/blob/main/resources/agent-memory.md"
...
← [回到 Stage 6：RAG 與 Memory](/zh-tw/stages/06-memory-rag/)
