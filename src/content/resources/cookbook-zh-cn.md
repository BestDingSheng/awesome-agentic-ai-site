---
title: "Cookbook — 把概念变成真的成果"
description: "这份 Cookbook 不要求你一次读完。先选一个想做的成果，复制它的第一个动作；需要更多步骤时，再打开选单。"
section: "Resource"
...
如果名词还不熟，先回 [Stage 5：Claude Code 生态系统](/stages/05-claude-code-ecosystem/)。想比较 OpenRouter、Pi、OpenCode 与 Ollama，直接看[完整 CLI Agent 指南](/resources/cli-agents-guide/)。
...
- [完整 CLI Agent 指南](/resources/cli-agents-guide/) 说明何时选 Claude Code、OpenCode、Pi、Aider、OpenRouter 或本地 runtime。
...
接着回 [Stage 5](/stages/05-claude-code-ecosystem/) 选下一个能力；要找更多工具，进入 [MCP／Skills Catalog](/resources/mcp-skills-catalog/)。
