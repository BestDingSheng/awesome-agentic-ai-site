...
description: "| 栏位 | 内容 | |---|---| | Stars | ★ 4.5k+ | | License | MIT | | 推荐度 | ⭐⭐⭐⭐⭐（官方） |"
section: "Resource"
...
- **想看 MCP / Skills / Plugins 是什么**：先看 [RESOURCES.zh-Hans.md 三个核心用语](../RESOURCES.zh-Hans.md#三个核心用语mcp--skills--plugins)，再看 [Stage 5 — Claude Code 生态系](/stages/05-claude-code-ecosystem/)
...
![Claude + 3 个 delegate skill 分工](/upstream/resources/diagrams/multi-llm-delegation-composition.zh-Hans.png)
...
PR 送出前看一下 [`resources/style-guide.zh-Hans.md`](/resources/style-guide/) 跟 [`CONTRIBUTING.zh-Hans.md`](../CONTRIBUTING.zh-Hans.md)。
