...
description: "GPT、Claude、Gemini 这类「给文字、回文字」的模型。本身是纯函数：input prompt → output text。它**不会自己上网、不会记住上次对话**——这些都要外接系统来做。"
section: "Resource"
...
📍 详细：[Stage 1](/zh-tw/stages/01-llm-basics-zh-hans/)
...
📍 详细：[Stage 2](/zh-tw/stages/02-prompt-engineering-zh-hans/)
...
📍 详细：[Stage 3](/zh-tw/stages/03-tool-use-and-hello-agent-zh-hans/)
...
📍 详细：[Stage 6](/zh-tw/stages/06-memory-rag-zh-hans/)
...
📍 详细：[Stage 7](/zh-tw/stages/07-multi-agent-production-zh-hans/)
...
📍 详细：[Stage 5.2](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#52--mcpmodel-context-protocol-基础)

### Skills / SKILL.md

Claude Code 的「行为包」。一个 Skill 就是一个文件夹含 `SKILL.md`（描述「在什么情境要做什么、可呼叫哪些 tool」），Claude Code 会根据当下情境自动载入合适的 skill。

📍 详细：[Stage 5.3](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#53--skillsclaude-code-的行為層)

### Plugin / Marketplace

把多个 Skills + slash commands + hooks + MCP 设置打包成一个发布单位。**Marketplace** 就是 plugin 的目录，社群可以 `claude plugin install` 安装别人写好的。

📍 详细：[Stage 5.4](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#54--plugins-与-marketplaces)
...
📍 详细：[Track A A1](/zh-tw/tracks/cli-a1-cli-intro-zh-hans/)、[`resources/cli-agents-guide.zh-Hans.md`](/zh-tw/resources/cli-agents-guide-zh-hans/)
...
📍 详细：[Stage 2 结尾](/zh-tw/stages/02-prompt-engineering/) / [Stage 6](/zh-tw/stages/06-memory-rag/) / [Stage 7](/zh-tw/stages/07-multi-agent-production/)
...
📍 详细：[Stage 7](/zh-tw/stages/07-multi-agent-production/) 必修阅读
...
- 看 [Stage 5.2 — MCP](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#52--mcpmodel-context-protocol-基础) / [5.3 — Skills](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#53--skillsclaude-code-的行為層) / [5.4 — Plugins](/zh-tw/stages/05-claude-code-ecosystem-zh-hans/#54--plugins-与-marketplaces) 的内文
- 看 [Stage 1](/zh-tw/stages/01-llm-basics-zh-hans/) / [Stage 6](/zh-tw/stages/06-memory-rag-zh-hans/) / [Stage 7](/zh-tw/stages/07-multi-agent-production-zh-hans/) 的延伸阅读清单
