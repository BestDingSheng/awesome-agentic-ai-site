...
description: "Installation and testing belong in Stage 5; this page only helps you find candidates."
section: "Resource"
...
Installation and testing belong in [Stage 5](/en/stages/05-claude-code-ecosystem/); this page only helps you find candidates.
...
Read [`resources/style-guide.en.md`](/en/resources/style-guide/) and [`CONTRIBUTING.en.md`](../CONTRIBUTING.en.md) before submitting.
