...
> If you already know which one you want → [`resources/cli-agents-guide.en.md`](/en/resources/cli-agents-guide/) (CLI agent identity & selection guide) or [`resources/cookbook.en.md`](/en/resources/cookbook/) (step-by-step deployment).
...
- **Choose a CLI agent that fits you** (Type 2 + Type 3) → [`resources/cli-agents-guide.en.md`](/en/resources/cli-agents-guide/)
