---
title: "How to classify Agent tools: identity, surface, and deployment"
description: "One tool can appear in a terminal, IDE, and desktop app. It can also connect to local or cloud models. Instead of forcing tools into five mutually exclusive “types,” ask three separate questions."
section: "Resource"
...
---
> [繁體中文](/zh-tw/resources/agent-paradigms/) | [简体中文](/resources/agent-paradigms/) | **English**

# How to classify Agent tools: identity, surface, and deployment

> [← Back to the main README](/en)
...
![The Identity, Surface, and Deployment axes for Agent tools](/upstream/resources/diagrams/agent-tool-axes.en.png)
...
Continue with [Stage 5 Subagents](/en/stages/05-claude-code-ecosystem/) and the [copy-ready Subagent Cookbook](/en/resources/subagent-cookbook/).
