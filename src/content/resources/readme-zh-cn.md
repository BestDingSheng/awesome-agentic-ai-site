---
title: "`resources/` 索引"
description: "| 文件 | 角色 | 什么时候看 | 行数 | |---|---|---|---| | glossary.zh-Hans.md | 30 秒查词典 | 看 stage 内容时遇到 LLM / RAG / token / agent / vector DB / streaming / batch API 不知道什么意思 | 210 | | cli-agents-guide.zh-Hans.md | 8 个 CLI agent 比较 | "
section: "Resource"
...
| [`cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/) | **8 个 CLI agent 比较** | 第一次选 CLI agent（Claude Code / Codex / OpenCode / Gemini CLI / goose / Aider / Hermes Agent / Grok Build）不知道挑哪个 | ~134 |
| [`mcp-skills-catalog.zh-Hans.md`](/resources/mcp-skills-catalog/) | **81+ 个集成 catalog** | 想把 Claude Code 接 Notion / Obsidian / Excel / Postgres / Slack / 等实际工具 | ~775 |
...
→ [`mcp-skills-catalog.zh-Hans.md`](/resources/mcp-skills-catalog/)（81+ 个集成分 16 类）
...
→ [`style-guide.zh-Hans.md`](/resources/style-guide/) + [`../CONTRIBUTING.zh-Hans.md`](../CONTRIBUTING.zh-Hans.md)
...
- `cost-calculator-guide.md`：cross-provider 计价。现在 [Stage 1](/stages/01-llm-basics/) 有提到，等需求明显再开。
- `troubleshooting-guide.md`：常见错误 runbook。现有资料够应付，等社群反馈多了再开。
- `prompt-patterns-guide.md`：CoT / few-shot 模板库。现在 [Stage 2](/stages/02-prompt-engineering/) 有基础内容，深度版等社群 PR。
