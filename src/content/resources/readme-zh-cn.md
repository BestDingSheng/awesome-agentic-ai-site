---
title: "`resources/` 索引"
description: "| 文件 | 角色 | 什么时候看 | 行数 | |---|---|---|---| | glossary.zh-Hans.md | 30 秒查词典 | 看 stage 内容时遇到 LLM / RAG / token / agent / vector DB / streaming / batch API 不知道什么意思 | 210 | | cli-agents-guide.zh-Hans.md | CLI agent 身份与选择指南 |"
section: "Resource"
...
| [`cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/) | **CLI agent 身份与选择指南** | 第一次选 CLI agent、不确定哪个工具适合自己的工作方式 | — |
