---
title: "`resources/` 工具柜"
description: "这里像一个工具柜。你卡住时，只拿现在需要的那张说明卡；不用从第一份读到最后一份。"
section: "Resource"
...
| 你现在想做什么 | 先打开这一份 |
|---|---|
| 我完全没写过 code，不知道怎么开始 | [`setup-guide.zh-Hans.md`](/resources/setup-guide/) |
| 我想按完整学习地图开始 | [主页](/) → [Stage 0](/stages/00-foundations/) |
| 我分不清模型怎么学会、怎么被调整、什么时候只是在生成答案 | [`model-training-guide.zh-Hans.md`](/resources/model-training-guide/) |
| 我看到一个词，但不知道意思 | [查词卡](/resources/glossary/) |
| 我分不清这四个名字：OpenRouter＝统一模型 API／router；Ollama＝本地模型 runtime；OpenCode／Pi＝coding agent／toolkit | [`cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/) |
| 我想做出第一个操作卡（Skill）、工具接头（MCP server）或文档流程 | [实践食谱](/resources/cookbook/) |
| 我写了工具说明（tool schema），但模型一直选错工具 | [`schema-design-cheatsheet.zh-Hans.md`](/resources/schema-design-cheatsheet/) |
| 我想找能接 Notion、Office、数据库或浏览器的工具 | [`mcp-skills-catalog.zh-Hans.md`](/resources/mcp-skills-catalog/) |
| 我想选一门课，或先看证书有没有用 | [`courses.zh-Hans.md`](/resources/courses/) |
| 我想知道 agent 是在终端、编辑器、云端还是自己的设备里工作 | [`agent-paradigms.zh-Hans.md`](/resources/agent-paradigms/) |
| 我想直接复制一个小助手 agent（subagent）派遣范例 | [`subagent-cookbook.zh-Hans.md`](/resources/subagent-cookbook/) |
| 我想自己设计、组合或排查小助手 agent（subagent） | [`subagent-advanced.zh-Hans.md`](/resources/subagent-advanced/) |
| 我想替这个项目写内容或提交 PR | [`style-guide.zh-Hans.md`](/resources/style-guide/) |
...
- 第一次学习：回到 [Stage 0](/stages/00-foundations/)。
- 想用 CLI 完成工作：回到 [Track A1](/tracks/cli-a1-cli-intro/)。
- 想自己写 Agent：回到 [Stage 3](/stages/03-tool-use-and-hello-agent/)。
- 只想重新选择入口：回到 [主页](/)。
...
提交修改前，再核对 [MCP／Skills catalog](/resources/mcp-skills-catalog/)、[Cookbook](/resources/cookbook/)、[style guide](/resources/style-guide/) 与 [CONTRIBUTING](../CONTRIBUTING.zh-Hans.md)。
