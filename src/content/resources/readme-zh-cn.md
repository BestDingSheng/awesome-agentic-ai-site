...
| [`mcp-skills-catalog.zh-Hans.md`](/resources/mcp-skills-catalog/) | **79+ 个集成 catalog** | 想把 Claude Code 接 Notion / Obsidian / Excel / Postgres / Slack / 等实际工具 | ~775 |
...
→ [`mcp-skills-catalog.zh-Hans.md`](/resources/mcp-skills-catalog/)（79+ 个集成分 16 类）
