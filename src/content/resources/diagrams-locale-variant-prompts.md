---
title: "語系變體圖 — 生成流程與教訓"
description: "新增 tool-use-loop.png、.en.png、.zh-Hans.png。三張都使用 16:9 亮色白底卡片，固定呈現 模型 → Tool Call → 程式驗證 → 工具執行 → Tool Result → 模型答案，並用盾牌框住程式驗證與工具執行。底部只保留三個安全提示：allowlist、敏感動作先問人、設定最大輪數。"
section: "Resource"
