---
title: "語系變體圖 — 生成流程與教訓"
description: "resources/diagrams/ 的慣例是 NAME.png = zh-TW、NAME.en.png、NAME.zh-Hans.png。 處理前有 5 張圖缺 9 個變體，導致 .en.md / .zh-Hans.md 頁面alt text 已在地化、圖檔還是繁中。"
section: "Resource"
...
> 姊妹檔：[`concept-prompts.md`](/zh-tw/resources/diagrams-concept-prompts/)（Stage 7.5 那 3 張概念圖的 ChatGPT prompt）。
