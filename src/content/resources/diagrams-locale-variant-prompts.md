---
title: "語系變體圖 — 生成流程與教訓"
description: "新增 claude-code-system-flow.png、.en.png、.zh-Hans.png。這組圖補上原本選擇圖沒有回答的問題：各零件如何接進同一次工作。三語都固定使用同一個 16:9 亮色版面與四種線條語意："
section: "Resource"
sourcePath: "resources/diagrams/locale-variant-prompts.md"
sourceUrl: "https://github.com/BestDingSheng/awesome-agentic-ai-zh/blob/main/resources/diagrams/locale-variant-prompts.md"
sourceRepo: "https://github.com/BestDingSheng/awesome-agentic-ai-zh"
syncedAt: "2026-09-02T03:38:49.833Z"
language: "zh-tw"
languageLabel: "繁體中文"
baseSlug: "diagrams-locale-variant-prompts"
---
# 語系變體圖 — 生成流程與教訓

> 姊妹檔：[`concept-prompts.md`](/zh-tw/resources/diagrams-concept-prompts/)（Stage 7.5 兩組三語概念圖的 Image 2.0 重產規格）。
...
不同 hash 與正文引用。完整文字表與重產限制在 [`concept-prompts.md`](/zh-tw/resources/diagrams-concept-prompts/)。
