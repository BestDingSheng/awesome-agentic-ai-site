...
> 姊妹檔：[`concept-prompts.md`](/zh-tw/resources/diagrams-concept-prompts/)（Stage 7.5 兩組三語概念圖的可重產文字與構圖規格）。
...
[`concept-prompts.md`](/zh-tw/resources/diagrams-concept-prompts/)。
