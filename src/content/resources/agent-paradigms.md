...
> 已經知道想用哪個 → [`resources/cli-agents-guide.md`](/zh-tw/resources/cli-agents-guide/)（CLI agent 身分與選擇指南）或 [`resources/cookbook.md`](/zh-tw/resources/cookbook/)（step-by-step 部署）。
...
- **想選擇適合的 CLI agent**（Type 2 + Type 3）→ [`resources/cli-agents-guide.md`](/zh-tw/resources/cli-agents-guide/)
