---
title: "Agent 工具怎麼分：身分、操作介面、部署位置"
description: "同一個工具可以出現在 Terminal、IDE 和 Desktop，也可以接本機或雲端模型。所以不要硬把工具塞進五個互斥「型態」。先問三個問題，會比較不容易混亂。"
section: "Resource"
...
---
> **繁體中文** | [简体中文](/resources/agent-paradigms/) | [English](/en/resources/agent-paradigms/)
...
![Agent 工具的 Identity、Surface 與 Deployment 三條軸](/upstream/resources/diagrams/agent-tool-axes.png)
...
延伸：[Stage 5 的 Subagents](/zh-tw/stages/05-claude-code-ecosystem/)與[可直接複製的 Subagent Cookbook](/zh-tw/resources/subagent-cookbook/)。
