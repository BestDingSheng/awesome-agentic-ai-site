---
title: "CLI Agents Reference Guide"
description: "This reference doc organizes 9 terminal CLIs around “what do you want to do now?” and checkable official sources. It does not score tools or choose an entry point by popularity or subjective ranking; first identify the r"
section: "Resource"
...
> [← Back to the main path README](/en) · [A1: Safely run your first small task](/en/tracks/cli-a1-cli-intro/)
...
- For your first safe operation, return to [A1](/en/tracks/cli-a1-cli-intro/).
- To fix rules files and repeatable workflows in place, go to [A2](/en/tracks/cli-a2-cli-workflow/).
- To work on MCP, CI, and usage traces, go to [A3](/en/tracks/cli-a3-cli-production/).
