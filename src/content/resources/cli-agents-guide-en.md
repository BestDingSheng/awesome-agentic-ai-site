---
title: "CLI Agents Comparison Guide"
description: "A cross-branch reference shared by Track A (A1-A3) + all 5 specialized branches: how to choose between Claude Code / Codex / OpenCode / Gemini CLI / goose / Aider / Hermes Agent / Grok Build? Every branch references CLI "
section: "Resource"
...
| [Grok Build](https://github.com/xai-org/grok-build) | SpaceXAI (xAI, official) | Apache-2.0 | Grok | Browser sign-in on first launch | ★ 20k+ |
...
- Step-by-step walkthrough: [`resources/cookbook.md` Recipe 6](/en/resources/cookbook/#6-local-llm--cli-agent-quick-walkthrough)
