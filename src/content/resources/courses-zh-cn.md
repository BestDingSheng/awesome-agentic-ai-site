---
title: "线上 AI Agent 课程（带证书对照）"
description: "图例：🆓 免费（含证书）· 💰 付费 · 🆓→💰 旁听免费、证书付费。"
section: "Resource"
...
> 📌 **这份是 reference catalog，不是排名。** 本 repo 是动手做的学习路线，**不取代**结构化线上课程——下面这些课程可当作平行的影片／互动式入门对照。想动手做 → 回 [stages](/)；想先查用语 → [`resources/glossary.zh-Hans.md`](/resources/glossary/)。本页只收**会发证书**的课程。
...
- ⭐ 星等照 [style-guide §2](/resources/style-guide/#2-推荐星等定义)：⭐⭐⭐⭐⭐ 必做 … ⭐ 利基。
