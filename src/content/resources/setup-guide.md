...
> 這份文件寫給「想學 AI agent，但還沒寫過 code」的人。已經熟 Python / git / CLI 的開發者，可以直接跳 [Stage 1](/zh-tw/stages/01-llm-basics/)。
...
→ 詳細比較 → [`branches/for-developer.md`](/zh-tw/branches/for-developer/)
...
| 你現在的狀態 | 下一步 |
|---|---|
| 想正式理解 LLM、API、token | [Stage 1 — LLM 基礎](/zh-tw/stages/01-llm-basics/) |
| 想直接挑身分分支 | [日常使用者](/zh-tw/branches/for-everyday-users/) / [教師](/zh-tw/branches/for-teacher/) / [知識工作者](/zh-tw/branches/for-knowledge-worker/) / [研究者](/zh-tw/branches/for-researcher/) / [開發者](/zh-tw/branches/for-developer/) |
| 想看 Claude Code 完整生態 | [Stage 5 — Claude Code 生態系](/zh-tw/stages/05-claude-code-ecosystem/) |
| 想本機 LLM、不用雲端 key | [Cookbook Recipe 6](/zh-tw/resources/cookbook/#6-本機-llm--cli-agent-快速-walkthrough) |
| 想比較 CLI agent | [CLI Agents 比較指南](/zh-tw/resources/cli-agents-guide/) |
| 不懂某個用詞 | [Glossary](/zh-tw/resources/glossary/) |
