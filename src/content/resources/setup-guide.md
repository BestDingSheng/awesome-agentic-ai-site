...
description: "這一頁不是叫你把所有工具都裝一遍。你只要先選一扇門，完成一個小結果。"
section: "Resource"
...
已經會用 Python、Git 和 terminal，也知道怎麼保護 **API Key（API 金鑰）**？可以直接去 [Stage 1](/zh-tw/stages/01-llm-basics/)。
...
| 寫 code 時請 AI 在旁邊協助 | **IDE Assistant**：住在 editor 裡 | 先看 [開發者路線](/zh-tw/branches/for-developer/) |
| 讓 Agent 在指定資料夾讀檔、改檔、跑命令 | **CLI Agent**：在 terminal 裡工作 | 先看 [CLI Agents 指南](/zh-tw/resources/cli-agents-guide/) |
...
本機推理沒有供應商模型 API 帳單，但硬體、電力、下載時間、裝置安全、檔案與 log 仍由你負責。完整路徑看 [Cookbook 的本機 LLM walkthrough](/zh-tw/resources/cookbook/#6-本機-llm--cli-agent-快速-walkthrough)。
...
更完整的責任邊界看 [Stage 5.3 — Skills](/zh-tw/stages/05-claude-code-ecosystem/#53--skillsclaude-code-的行為層-claude-code-生態最關鍵的一層)，更多範例看 [Cookbook](/zh-tw/resources/cookbook/)。
...
| 你現在想做什麼 | 下一站 |
|---|---|
| 理解模型、Token、Context Window 與 API | [Stage 1 — LLM 基礎](/zh-tw/stages/01-llm-basics/) |
| 直接學 Prompt | [Stage 2 — Prompt Engineering](/zh-tw/stages/02-prompt-engineering/) |
| 用 CLI Agent 工作 | [Track A1 — CLI 入門](/zh-tw/tracks/cli-a1-cli-intro/) |
| 理解 Claude Code、MCP、Skills、Plugins 與 Subagents | [Stage 5 — Claude Code 生態系](/zh-tw/stages/05-claude-code-ecosystem/) |
| 使用本機模型 | [Cookbook：本機 LLM walkthrough](/zh-tw/resources/cookbook/#6-本機-llm--cli-agent-快速-walkthrough) |
| 還分不清 OpenRouter、Ollama、OpenCode 或 Pi | [Glossary：先分清五種工具身分](/zh-tw/resources/glossary/#-先分清五種工具身分) |
