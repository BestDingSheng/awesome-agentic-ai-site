---
title: "線上 AI Agent 課程（帶證書對照）"
description: "圖例：🆓 免費（含證書）· 💰 付費 · 🆓→💰 旁聽免費、證書付費。"
section: "Resource"
...
> 📌 **這份是 reference catalog，不是排名。** 本 repo 是動手做的學習路線，**不取代**結構化線上課程——下面這些課程可當作平行的影片／互動式入門對照。想動手做 → 回 [stages](/zh-tw)；想先查用語 → [`resources/glossary.md`](/zh-tw/resources/glossary/)。本頁只收**會發證書**的課程。
...
- ⭐ 星等照 [style-guide §2](/zh-tw/resources/style-guide/#2-推薦星等定義)：⭐⭐⭐⭐⭐ 必做 … ⭐ 利基。
