---
title: "AI Agent 課程地圖：先學會，再決定要不要拿證書"
description: "這一頁幫你做一件事：從很多課裡，挑一門真的適合現在的你。 不必先蒐集證書，也不必一次報名五門。先選一門、做出一個可以展示的作品，再走下一步。"
section: "Resource"
sourcePath: "resources/courses.md"
sourceUrl: "https://github.com/BestDingSheng/awesome-agentic-ai-zh/blob/main/resources/courses.md"
...
> **繁體中文** | [简体中文](/resources/courses/) | [English](/en/resources/courses/)
...
想照本專案一步一步實作，回到 [主學習路線](/zh-tw)；看到陌生名詞，可查 [用語小辭典](/zh-tw/resources/glossary/)。
...
最小作品可以只是一個會查資料、呼叫一個工具、留下 Eval 結果的小 Agent。完成後再回本專案對照 [Stage 3 工具使用](/zh-tw/stages/03-tool-use-and-hello-agent/)、[Stage 4 Workflow Graph](/zh-tw/stages/04-agent-frameworks/) 與 [Stage 7 上線工程](/zh-tw/stages/07-multi-agent-production/)。
