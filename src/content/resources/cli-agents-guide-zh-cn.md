...
| [Grok Build](https://github.com/xai-org/grok-build) | SpaceXAI（xAI，官方） | Apache-2.0 | Grok | 首次启动开浏览器完成登录 | ★ 20k+ |
...
- Step-by-step 做法看 [`resources/cookbook.md` Recipe 6](/resources/cookbook/#6-本地-llm--cli-agent-快速-walkthrough)
