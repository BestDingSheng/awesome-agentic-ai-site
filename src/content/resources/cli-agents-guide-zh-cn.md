...
---> [繁體中文](/resources/cli-agents-guide/) | **简体中文** | [English](/resources/cli-agents-guide-en/)
...
> 第一次接触 CLI agent、想要 step-by-step 上手 → 看 [`tracks/cli/A1-cli-intro.zh-CN.md`](/tracks/a1-cli-intro-zh-cn/)（Track A 第一站）。
> 已经在用、想决定 / 比较 / 升级 → 留在这份。
...
只列在 terminal 跑的（IDE-based 如 Cursor / Cline / Continue 不在这份；那些放在 [for-developer](/branches/for-developer-zh-cn/)）。所有数字 `gh api` 验证于 2026-05-06。
...
- **[for-developer](/branches/for-developer-zh-cn/)**：除了 CLI，也看 IDE-based agents（Cursor、Cline、Continue）
- **[for-everyday-users](/branches/for-everyday-users-zh-cn/)** Tier 2：CLI 是进阶选项，先试 Tier 0 / 1 的 Web / Desktop App
- **[for-researcher](/branches/for-researcher-zh-cn/)**：除了 CLI，也看 paper-specific 工具（paper-qa、gpt-researcher、ChatPaper）
- **[for-knowledge-worker](/branches/for-knowledge-worker-zh-cn/)**：除了 CLI，也看 workflow 自动化（n8n、Make）
- **[for-teacher](/branches/for-teacher-zh-cn/)**：CLI 对教师偏进阶；建议先看 prompt 素材库
