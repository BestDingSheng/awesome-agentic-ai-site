...
> 已经知道想用哪个 → [`resources/cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/)（CLI agent 身份与选择指南）或 [`resources/cookbook.zh-Hans.md`](/resources/cookbook/)（step-by-step 部署）。
...
- **想选择适合的 CLI agent**（Type 2 + Type 3）→ [`resources/cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/)
