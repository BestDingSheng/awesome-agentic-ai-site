...
| [`cli-agents-guide.en.md`](/en/resources/cli-agents-guide/) | **8 CLI agents compared** | First time choosing among Claude Code / Codex / OpenCode / Gemini CLI / goose / Aider / Hermes Agent / Grok Build | ~134 |
| [`mcp-skills-catalog.en.md`](/en/resources/mcp-skills-catalog/) | **79+ integration catalog** | You want Claude Code connected to Notion / Obsidian / Excel / Postgres / Slack / other real tools | ~775 |
...
| [`style-guide.en.md`](/en/resources/style-guide/) | **Format and wording rules before PRs** | You want to contribute to the repo, add entries, or improve translations | ~338 |
...
→ [`setup-guide.en.md`](/en/resources/setup-guide/) (30-45 minutes from zero)

### 🆕 I Am Just Starting to Learn AI Agents

You do not need any reference first. **Start with the main [README](/en) → [Stage 0](/en/stages/00-foundations/)**. When a term is unclear, come back to [`glossary.en.md`](/en/resources/glossary/).

### 🛠 I Need to Choose a CLI Agent

→ [`cli-agents-guide.en.md`](/en/resources/cli-agents-guide/) (CLI comparison + recommendations by use case)

### 🔌 I Want to Connect Claude Code to Tool X (Notion / Excel / Postgres / etc.)

→ [`mcp-skills-catalog.en.md`](/en/resources/mcp-skills-catalog/) (79+ integrations in 16 categories)

### 🍳 I Want to Build My First Skill / MCP Server / Word Integration

→ [`cookbook.en.md`](/en/resources/cookbook/) (6 step-by-step recipes)

### 📐 I Wrote a Tool Schema and the LLM Is Not Following It

→ [`schema-design-cheatsheet.en.md`](/en/resources/schema-design-cheatsheet/) (5 rules + 5 anti-patterns)

### 📚 I Hit an Unclear Term While Reading a Stage

→ [`glossary.en.md`](/en/resources/glossary/) (30-80 words per term + which stage goes deeper)

### 🤝 I Want to Send a PR / Translate / Add a New Entry

→ [`style-guide.en.md`](/en/resources/style-guide/) + [`../CONTRIBUTING.en.md`](../CONTRIBUTING.en.md)
...
- `cost-calculator-guide.md`: cross-provider pricing. [Stage 1](/en/stages/01-llm-basics/) covers enough for now.
- `troubleshooting-guide.md`: common error runbook. Existing material is enough until more community reports arrive.
- `prompt-patterns-guide.md`: CoT / few-shot template library. [Stage 2](/en/stages/02-prompt-engineering/) already covers the basics; a deeper version can wait for community PRs.
