---
title: "The `resources/` Tool Cabinet"
description: "Think of this folder as a tool cabinet. When you get stuck, take only the card you need now. You do not need to read every file from top to bottom."
section: "Resource"
...
|---|---|
| I have never coded and do not know where to start | [`setup-guide.en.md`](/en/resources/setup-guide/) |
| I want to follow the complete learning map | [Home](/en) → [Stage 0](/en/stages/00-foundations/) |
| I cannot tell how models learn, how they are adapted, and when they are only producing an answer | [`model-training-guide.en.md`](/en/resources/model-training-guide/) |
| I see a term but do not know what it means | [Term lookup](/en/resources/glossary/) |
| I cannot tell these names apart: OpenRouter = unified model API/router; Ollama = local model runtime; OpenCode/Pi = coding agents/toolkits | [`cli-agents-guide.en.md`](/en/resources/cli-agents-guide/) |
| I want to build my first action card (Skill), tool connector (MCP server), or document workflow | [Hands-on recipes](/en/resources/cookbook/) |
| I wrote a tool description (tool schema), but the model keeps choosing the wrong tool | [`schema-design-cheatsheet.en.md`](/en/resources/schema-design-cheatsheet/) |
| I need a tool for Notion, Office, a database, or a browser | [`mcp-skills-catalog.en.md`](/en/resources/mcp-skills-catalog/) |
| I want to choose a course or check whether a certificate helps | [`courses.en.md`](/en/resources/courses/) |
| I want to know whether an agent works in a terminal, editor, cloud, or my own device | [`agent-paradigms.en.md`](/en/resources/agent-paradigms/) |
| I want a helper-agent (subagent) dispatch example I can copy now | [`subagent-cookbook.en.md`](/en/resources/subagent-cookbook/) |
| I want to design, combine, or debug helper agents (subagents) | [`subagent-advanced.en.md`](/en/resources/subagent-advanced/) |
| I want to write content or send a PR to this project | [`style-guide.en.md`](/en/resources/style-guide/) |
...
- First-time learner: return to [Stage 0](/en/stages/00-foundations/).
- Want to finish work with a CLI: return to [Track A1](/en/tracks/cli-a1-cli-intro/).
- Want to build an Agent: return to [Stage 3](/en/stages/03-tool-use-and-hello-agent/).
- Want to choose an entrance again: return to [Home](/en).
...
Before submitting a change, check the [MCP/Skills catalog](/en/resources/mcp-skills-catalog/), [Cookbook](/en/resources/cookbook/), [style guide](/en/resources/style-guide/), and [CONTRIBUTING](../CONTRIBUTING.en.md).
