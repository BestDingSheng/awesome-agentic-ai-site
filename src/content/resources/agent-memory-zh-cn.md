---
title: "Agent Memory：只记值得记、允许记、能删掉的事"
description: "Agent Memory（代理记忆）像一本有管理规则的笔记本。它不是把所有聊天偷偷存起来；它只保存之后真的需要、用户允许，而且可以查看、修改与删除的内容。"
section: "Resource"
sourcePath: "resources/agent-memory.zh-Hans.md"
sourceUrl: "https://github.com/BestDingSheng/awesome-agentic-ai-zh/blob/main/resources/agent-memory.zh-Hans.md"
sourceRepo: "https://github.com/BestDingSheng/awesome-agentic-ai-zh"
syncedAt: "2026-09-02T03:38:49.833Z"
language: "zh-cn"
languageLabel: "简体中文"
baseSlug: "agent-memory"
---
# Agent Memory：只记值得记、允许记、能删掉的事

[繁體中文](/zh-tw/resources/agent-memory/) | [English](/en/resources/agent-memory/) | [简体中文](/resources/agent-memory/)
...
← [回到 Stage 6：RAG 与 Memory](/stages/06-memory-rag/)
