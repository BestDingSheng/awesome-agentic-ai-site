---
title: "Glossary"
description: "This table is the project's enforced naming convention — every stage uses the same Chinese readability label for each English term. If you see drift inside a stage, please file an issue."
section: "Resource"
...
📍 Five identities compared: [Track A A1](/en/tracks/cli-a1-cli-intro/)
...
📍 Detail + routing: [Stage 3 Reflection](/en/stages/03-tool-use-and-hello-agent/#-reflection-reflexion--self-refine--concept--routing)
...
📍 Detail: [Stage 6 What is Memory + How to Design It](/en/stages/06-memory-rag/#-what-is-memory--how-to-design-it) + [Stage 6 CoALA Framework](/en/stages/06-memory-rag/#advanced-coala-framework--a-4-layer-taxonomy-for-agent-memory)
...
📍 Detail: [Stage 6 Advanced: Full Reflexion with Persistent Memory](/en/stages/06-memory-rag/#-advanced-full-reflexion-with-persistent-memory--track-b-elective)
...
📍 Getting started: [Track A A2](/en/tracks/cli-a2-cli-workflow/)
...
📍 Getting started: [Track A A2](/en/tracks/cli-a2-cli-workflow/); Claude Code deep dive: [Stage 5.3](/en/stages/05-claude-code-ecosystem/#53--skills-claude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem)
...
📍 Practice: [Track A A2 CLI-8](/en/tracks/cli-a2-cli-workflow/#cli-8)
...
📍 Practice: [Track A A3 CLI-10](/en/tracks/cli-a3-cli-production/#cli-10)
...
📍 Getting started: [Stage 2](/en/stages/02-prompt-engineering/); full eval harness: [Stage 7](/en/stages/07-multi-agent-production/)
...
📍 Getting started: [Track A A3 CLI-11](/en/tracks/cli-a3-cli-production/#cli-11); deep dive: [Stage 7](/en/stages/07-multi-agent-production/)
...
📍 Discipline-level concept (**8 core components** / Prompt→Context→Harness→Loop→Graph five-layer engineering split / framework vs harness): [Stage 7 Harness Engineering](/en/stages/07-multi-agent-production/)
...
- **The "graph" here is a control / execution graph, not the knowledge-graph retrieval of GraphRAG** — for that, see [Stage 6](/en/stages/06-memory-rag/). The two are frequently conflated.
...
**Relationship to loops**: this is not either-or. **Inside a box, the agent loops; between boxes, you define the order**. A graph puts several loops into boxes, then orders those boxes. If you put everything back into one box, you are back to a plain loop. A box does not have to contain an agent either; it can be a tool, a check, or a "human approval required before continuing" gate. For the full five-layer ladder, see [Stage 7](/en/stages/07-multi-agent-production/) (canonical).

Start with tools and basic graphs in [Stage 4's Agent framework / Workflow Graph](/en/stages/04-agent-frameworks/), then go to [Stage 7](/en/stages/07-multi-agent-production/) for budgets, verification, observability, and recovery. The runnable entry point is [`examples/stage-4/03-graph-workflow/`](/en) (`StateGraph` / conditional edges / checkpointer). Related: harness, Loop Engineering, orchestration.
...
📍 Complete loop, current tools, and benchmark reading: [Stage 8 Computer Use](/en/stages/08-agent-interfaces/#-computer-use--the-screen-level-agent)
...
📍 Complete signal comparison and current frameworks: [Stage 8 Browser Use](/en/stages/08-agent-interfaces/#-browser-use--the-web-level-agent)
...
📍 Full nine-row terminology glossary and provider choice: [Stage 8 Code Sandbox](/en/stages/08-agent-interfaces/#-code-execution-sandbox--the-isolated-environment-with-mini-glossary)
...
📍 Full comparison: [Stage 8 terminology glossary](/en/stages/08-agent-interfaces/#-mini-glossary-of-isolation-technologies)
...
📍 [Stage 8 terminology glossary](/en/stages/08-agent-interfaces/#-mini-glossary-of-isolation-technologies)
