---
title: "Glossary"
description: "When an unfamiliar term appears, you do not need to stop reading the whole chapter. Find one plain-language explanation here, then return to the Stage you were working on."
section: "Resource"
...
📍 Details: [Stage 1](/en/stages/01-llm-basics/)
...
A **Context Window** is the token space a model can consider in one call. A larger space does not make every part equally important; include what the task needs, then check [Stage 1](/en/stages/01-llm-basics/) for current official limits.
...
📍 Details: [Stage 2](/en/stages/02-prompt-engineering/)
...
📍 Optional guide: [Model training and adaptation guide](/en/resources/model-training-guide/)
...
📍 Details: [Stage 3](/en/stages/03-tool-use-and-hello-agent/)
...
📍 Details: [Stage 4](/en/stages/04-agent-frameworks/)
...
📍 Details: [Stage 6](/en/stages/06-memory-rag/)
...
📍 Details: [Stage 5.2](/en/stages/05-claude-code-ecosystem/#52--mcp-model-context-protocol--foundation)
...
📍 Start: [Track A A2](/en/tracks/cli-a2-cli-workflow/)
...
📍 Learn: [Stage 5.5](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature) · [copyable recipes](/en/resources/subagent-cookbook/) · [advanced composition](/en/resources/subagent-advanced/)
...
📍 Start: [Stage 2](/en/stages/02-prompt-engineering/); Agent systems: [Stage 7](/en/stages/07-multi-agent-production/)
...
A **Frontier Model** is a model near the capability frontier at a particular time, not a permanent roster. Model names, prices, Context, and availability change quickly; use the [official-source table in Stage 1](/en/stages/01-llm-basics/) for current facts.
...
Here, graph means an execution flow rather than the GraphRAG knowledge graph in Stage 6. Learn a basic Workflow Graph in [Stage 4](/en/stages/04-agent-frameworks/), then add production boundaries in [Stage 7](/en/stages/07-multi-agent-production/).
...
To compare Search / Fetch, Browser Use, Computer Use, and Sandboxes, return to [Stage 8](/en/stages/08-agent-interfaces/).
...
- See [Stage 5.2 on MCP](/en/stages/05-claude-code-ecosystem/#52--mcp-model-context-protocol--foundation), [Stage 5.3 on Skills](/en/stages/05-claude-code-ecosystem/#53--skills-claude-codes-behavior-layer--the-most-critical-layer-of-the-claude-code-ecosystem), or [Stage 7 production boundaries](/en/stages/07-multi-agent-production/).
