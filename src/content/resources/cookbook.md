...
<details markdown="1">
<summary>展開主要路徑：OpenCode 2 beta＋Ollama</summary>

OpenCode 2 目前仍是 beta，binary 叫 `opencode2`，不會覆蓋舊版 `opencode`：
...
| [OpenCode 2](https://opencode.ai/v2/docs) | beta 狀態、`opencode2` 與本機模型 discovery | ⭐⭐⭐⭐⭐ |
