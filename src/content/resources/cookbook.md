---
title: "Cookbook — 把概念變成真的成果"
description: "這份 Cookbook 不要求你一次讀完。先選一個想做的成果，複製它的第一個動作；需要更多步驟時，再打開選單。"
section: "Resource"
...
如果名詞還不熟，先回 [Stage 5：Claude Code 生態系](/zh-tw/stages/05-claude-code-ecosystem/)。想比較 OpenRouter、Pi、OpenCode 與 Ollama，直接看[完整 CLI Agent 指南](/zh-tw/resources/cli-agents-guide/)。
...
[`PleasePrompto/notebooklm-skill`](https://github.com/PleasePrompto/notebooklm-skill) 已封存（2026-09-10 UTC 查核），不再提供更新或支援。它展示用瀏覽器查詢 notebook 的歷史做法，並非 Google 官方整合；新流程請用官方網頁，或另行評估上面的 `notebooklm-py`。
...
| 想研究早期瀏覽器 Skill 設計 | `notebooklm-skill`（已封存，只作歷史參考） |
...
- [完整 CLI Agent 指南](/zh-tw/resources/cli-agents-guide/) 說明何時選 Claude Code、OpenCode、Pi、Aider、OpenRouter 或本機 runtime。
...
<table>
  ...
  <tbody>
    ...
    <tr><td><a href="https://github.com/PleasePrompto/notebooklm-skill">notebooklm-skill</a></td><td>研究早期瀏覽器 Skill 設計</td><td>已封存；非官方，只作歷史參考</td><td>⭐⭐⭐</td></tr>
  </tbody>
  <tbody>
...
接著回 [Stage 5](/zh-tw/stages/05-claude-code-ecosystem/) 選下一個能力；要找更多工具，進入 [MCP／Skills Catalog](/zh-tw/resources/mcp-skills-catalog/)。
