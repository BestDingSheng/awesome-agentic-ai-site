---
title: "`resources/` 工具櫃"
description: "這裡像一個工具櫃。你卡住時，只拿現在需要的那張說明卡；不用從第一份讀到最後一份。"
section: "Resource"
...
| 我寫了工具說明（tool schema），但模型一直選錯工具 | [`schema-design-cheatsheet.md`](/zh-tw/resources/schema-design-cheatsheet/) |
| 我想找能接 Notion、Office、資料庫或瀏覽器的工具 | [`mcp-skills-catalog.md`](/zh-tw/resources/mcp-skills-catalog/) |
| 我想選一門課，或先看證書有沒有用 | [`courses.md`](/zh-tw/resources/courses/) |
| 我想知道 agent 是在終端機、編輯器、雲端或自己的裝置裡工作 | [`agent-paradigms.md`](/zh-tw/resources/agent-paradigms/) |
| 我想直接複製一個小幫手 agent（subagent）派遣範例 | [`subagent-cookbook.md`](/zh-tw/resources/subagent-cookbook/) |
| 我想自己設計、組合或排查小幫手 agent（subagent） | [`subagent-advanced.md`](/zh-tw/resources/subagent-advanced/) |
| 我想替這個專案寫內容或送 PR | [`style-guide.md`](/zh-tw/resources/style-guide/) |
...
- 第一次學習：回到 [Stage 0](/zh-tw/stages/00-foundations/)。
- 想用 CLI 完成工作：回到 [Track A1](/zh-tw/tracks/cli-a1-cli-intro/)。
- 想自己寫 Agent：回到 [Stage 3](/zh-tw/stages/03-tool-use-and-hello-agent/)。
- 只想重新選入口：回到 [主頁](/zh-tw)。
...
送出修改前，再核對 [MCP／Skills catalog](/zh-tw/resources/mcp-skills-catalog/)、[Cookbook](/zh-tw/resources/cookbook/)、[style guide](/zh-tw/resources/style-guide/) 與 [CONTRIBUTING](../CONTRIBUTING.md)。
