---
title: "`resources/` 索引"
description: "| 檔案 | 角色 | 什麼時候看 | 行數 | |---|---|---|---| | glossary.md | 30 秒查詞典 | 看 stage 內文時遇到 LLM / RAG / token / agent / vector DB / streaming / batch API 不知道什麼意思 | 210 | | cli-agents-guide.md | CLI agent 身分與選擇指南 | 第一次選 CLI agent、"
section: "Resource"
...
| [`cli-agents-guide.md`](/zh-tw/resources/cli-agents-guide/) | **CLI agent 身分與選擇指南** | 第一次選 CLI agent、不確定哪個工具適合自己的工作方式 | — |
| [`mcp-skills-catalog.md`](/zh-tw/resources/mcp-skills-catalog/) | **81+ 個整合 catalog** | 想把 Claude Code 接 Notion / Obsidian / Excel / Postgres / Slack / 等等實際工具 | ~775 |
...
| [`setup-guide.md`](/zh-tw/resources/setup-guide/) | **從零開始的 setup 指南** | 完全沒 dev 背景、第一次申請 API key / 裝 Python / 用 Claude Code | ~400 |
...
→ [`setup-guide.md`](/zh-tw/resources/setup-guide/)（30-45 分鐘從零裝好）
...
→ [`mcp-skills-catalog.md`](/zh-tw/resources/mcp-skills-catalog/)（81+ 個整合分 16 類）

### 🍳 我想動手寫第一個 Skill / MCP server / 接 Word 等

→ [`cookbook.md`](/zh-tw/resources/cookbook/)（6 個 step-by-step recipe）
