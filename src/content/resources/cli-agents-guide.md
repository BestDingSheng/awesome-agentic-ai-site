---
title: "CLI Agents 參考指南"
description: "這份 reference doc 用「現在要做什麼」和可核對的官方資料整理 9 個 terminal CLI。它不替工具打分，也不以熱門度或主觀排行決定入口；先看身分，再依你的 provider、登入方式與安全邊界選擇。"
section: "Resource"
...
> [← 回主路線 README](/zh-tw) · [A1：安全地跑第一個小任務](/zh-tw/tracks/cli-a1-cli-intro/)
...
- 要第一次安全操作：回到 [A1](/zh-tw/tracks/cli-a1-cli-intro/)。
- 要把規則檔與重複流程固定下來：進入 [A2](/zh-tw/tracks/cli-a2-cli-workflow/)。
- 要做 MCP、CI 與 usage trace：進入 [A3](/zh-tw/tracks/cli-a3-cli-production/)。
