...
description: "这是一份跨 7 个 stage 的具体 walkthrough——同一个 agent，从 Stage 1 写到 Stage 7，每个 stage 都附可执行的代码骨架。"
section: "Walkthrough"
...
2. 再读 [Stage 8 — Agent 操作界面](/stages/08-agent-interfaces/)，决定它需要 Search、Browser Use、Computer Use 还是 Sandbox，并补上安全边界。
