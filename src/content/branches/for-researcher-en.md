...
description: "This page does not make AI your researcher. It helps with one simpler task: find sources, understand them, and confirm that answers are actually supported by evidence."
section: "Branch"
...
- If you use a terminal or Python, come after [Track A A3](/en/tracks/cli-a3-cli-production/) or [Track B Stage 7](/en/stages/07-multi-agent-production/).
...
Next: use [Stage 6](/en/stages/06-memory-rag/) for literature RAG; [Stage 7](/en/stages/07-multi-agent-production/) for multiple agents; and the [MCP / Skills catalog](/en/resources/mcp-skills-catalog/) for external tools.
...
| Data cannot go to the cloud | Use an institutional environment; consider the local RAG route in [Stage 6](/en/stages/06-memory-rag/) |
