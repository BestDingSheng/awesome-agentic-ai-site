...
description: "下表把日常使用者一天會遇到的 7 個情境拆開——多數場景在網頁版（Tier 0）就能搞定："
section: "Branch"
...
> 🚀 **日常使用者可直接從 Tier 0 開始**（網頁 / 手機 App）、**不需要任何 setup**。只有當你想跑本地 LLM（Tier 3）或用 CLI 自動化（Tier 2）時、才需要看 [`resources/setup-guide.md` A-C](/zh-tw/resources/setup-guide/)（30 分鐘從零裝好）。
...
>
> 想知道哪種 CLI agent 適合你？見 [`resources/cli-agents-guide.md`](/zh-tw/resources/cli-agents-guide/)（依工作方式選工具、常見坑、實用搭配）。
>
> 想要 step-by-step 上手？見 [`tracks/cli/A1-cli-intro.md`](/zh-tw/tracks/cli-a1-cli-intro/)（Track A 第一站，從安裝到第一個任務）。
>
> 想把 CLI agent 接到你的 Notion / Obsidian / Excel / Google 文件等日常工具？見 [`resources/mcp-skills-catalog.md`](/zh-tw/resources/mcp-skills-catalog/)（按分類整理 81+ 個 MCP server / Skill）。
