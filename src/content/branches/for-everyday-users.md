...
>
> 想把 CLI agent 接到你的 Notion / Obsidian / Excel / Google 文件等日常工具？見 [`resources/mcp-skills-catalog.md`](/zh-tw/resources/mcp-skills-catalog/)（按分類整理 77+ 個 MCP server / Skill）。
