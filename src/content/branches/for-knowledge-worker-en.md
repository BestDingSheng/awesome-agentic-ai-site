---
title: "Extension Path: For Knowledge Workers"
description: "Common work includes sorting email, turning meetings into Action Items, drafting weekly reports, organizing product requirements, summarizing research, and maintaining a Knowledge Base."
section: "Branch"
...
> [← Back to the main route](/en) · Continue after **Track A A3** or **Track B Stage 7**. No development background is required: start with one-off tasks and connect tools only when work repeats.
...
Do not install MCP just because you see it. Ask whether an in-service App／Connector is safe enough; use [Stage 5.2 — MCP](/en/stages/05-claude-code-ecosystem/#52--mcp-model-context-protocol--foundation) only for custom tools or reuse across clients.
...
Next: custom connections via [Stage 5.2 — MCP](/en/stages/05-claude-code-ecosystem/#52--mcp-model-context-protocol--foundation); long-running workflows via [Stage 7](/en/stages/07-multi-agent-production/); code via the [Developer path](/en/branches/for-developer/).
