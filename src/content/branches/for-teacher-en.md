---
title: "Extension Path: For Teachers / Educators"
description: "AI can draft first; teachers decide whether the result is usable. This path shows you how to use AI to prepare materials, design practice, and organize feedback while protecting student information and keeping judgment w"
section: "Branch"
...
If this is your first visit, start with the short exercise on this page. You only need a **school-approved AI tool**; you do not need to learn programming first. When you want large-scale automation, continue to [Track A](/en/tracks/cli-a1-cli-intro/).
...
![Five-step teacher review loop for AI-assisted materials](/upstream/resources/diagrams/teacher-ai-review-loop.en.png)
...
Next stop: use [Track A](/en/tracks/cli-a1-cli-intro/) for daily automation; use [Stage 3](/en/stages/03-tool-use-and-hello-agent/) to build a teaching Agent; use [Stage 6](/en/stages/06-memory-rag/) for a materials knowledge base; and see the [Researcher path](/en/branches/for-researcher/) if you also do research.
...
- When repeating the same workflow weekly: read [Track A](/en/tracks/cli-a1-cli-intro/), but confirm account, permission, and data boundaries with school IT first.
...
- Course Agents: complete [Stage 3](/en/stages/03-tool-use-and-hello-agent/) before adding tools; do not connect LMS write permissions at the start.
- Private materials knowledge bases: see [Stage 6](/en/stages/06-memory-rag/), and first confirm materials licensing, retention location, and deletion method.
