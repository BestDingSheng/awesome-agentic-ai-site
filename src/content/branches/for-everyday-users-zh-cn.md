---
title: "给日常用户 — 专业分支"
description: "按「**动手意愿**」分 4 层，从低到高："
section: "Branch"
sourcePath: "branches/for-everyday-users.zh-CN.md"
sourceUrl: "https://github.com/BestDingSheng/awesome-agentic-ai-zh/blob/main/branches/for-everyday-users.zh-CN.md"
...
>
> 想看详细比较？见 [`resources/cli-agents-guide.zh-CN.md`](/resources/cli-agents-guide/)（6 个主流 CLI agent 并列、依 use case 推荐、常见坑、实用搭配）。
>
> 想要 step-by-step 上手？见 [`tracks/cli/A1-cli-intro.zh-CN.md`](/tracks/cli-a1-cli-intro/)（Track A 第一站，从安装到第一个任务）。
>
> 想把 CLI agent 接到你的 Notion / Obsidian / Excel / Google 文件等日常工具？见 [`resources/mcp-skills-catalog.zh-CN.md`](/resources/mcp-skills-catalog/)（按分类整理 62 个 MCP server / Skill）。
