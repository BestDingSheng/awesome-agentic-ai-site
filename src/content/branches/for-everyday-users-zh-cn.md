---
title: "日常使用者延伸路线（For Everyday Users）"
...
> 🚀 **日常使用者可直接从 Tier 0 开始**（网页 / 手机 App）、**不需要任何 setup**。只有当你想跑本地 LLM（Tier 3）或用 CLI 自动化（Tier 2）时，才需要看 [`resources/setup-guide.zh-Hans.md` A-C](/resources/setup-guide/)（30 分钟从零装好）。
