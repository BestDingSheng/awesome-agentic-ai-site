---
title: "研究人员延伸路线（For Researchers）"
description: "Gemini Notebook 是 Google 于 2026-07-16 为 NotebookLM 使用的现行名称；旧名称仅用于辨识。citation 是查证入口，不保证答案正确。"
section: "Branch"
...
- 会用终端或 Python：完成 [Track A 的 A3](/tracks/cli-a3-cli-production/) 或 [Track B 的 Stage 7](/stages/07-multi-agent-production/) 后再来。
...
下一站：想做文献 RAG，走 [Stage 6](/stages/06-memory-rag/)；想让多个 agent 分工，走 [Stage 7](/stages/07-multi-agent-production/)；想连接外部工具，看 [MCP／Skills catalog](/resources/mcp-skills-catalog/)。
...
| 数据不能上传云端 | 使用机构核准环境；必要时看 [Stage 6](/stages/06-memory-rag/) 的本机 RAG 路线 |
