---
title: "教师延伸路线（For Teachers / Educators）"
description: "AI 可以先做草稿，教师负责决定能不能用。这条路教你用 AI 准备教材、设计练习与整理反馈，同时保护学生数据，不把判断交给机器。"
section: "Branch"
...
第一次来，先做本页的小练习。你只需要一个**学校核准的 AI 工具**；不需要先学编程。想做大量自动化时，再走 [Track A](/tracks/cli-a1-cli-intro/)。
...
![教师把关 AI 教材的五步循环](/upstream/resources/diagrams/teacher-ai-review-loop.zh-Hans.png)
...
下一站：做日常自动化可走 [Track A](/tracks/cli-a1-cli-intro/)；自己建立教学 Agent 可走 [Stage 3](/stages/03-tool-use-and-hello-agent/)；要做教材知识库可走 [Stage 6](/stages/06-memory-rag/)；也做研究则看[研究人员路线](/branches/for-researcher/)。
...
- 每周重跑相同流程：阅读 [Track A](/tracks/cli-a1-cli-intro/)，但先和校方 IT 确认账号、权限与数据边界。
...
![教师与 AI agent 使用场景总览](/upstream/resources/diagrams/teacher-ai-use-cases-overview.zh-Hans.png)
...
- 课程 Agent：先完成 [Stage 3](/stages/03-tool-use-and-hello-agent/)，再加工具；不要一开始就接 LMS 写入权限。
- 私有教材知识库：看 [Stage 6](/stages/06-memory-rag/)，并先确认教材授权、保存位置与删除方式。
