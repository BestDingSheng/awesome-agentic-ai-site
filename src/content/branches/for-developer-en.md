---
title: "Extension Path: For Developers"
description: "An AI coding assistant reads files, edits code, and runs commands. It is fast and can be wrong. This path teaches you to narrow the task, understand each change, and let a person decide whether to keep it."
section: "Branch"
...
Recommended route: `A1 → A2 → Stage 5 core 5.1–5.4 → A3`. Progress through [A1](/en/tracks/cli-a1-cli-intro/), [A2](/en/tracks/cli-a2-cli-workflow/), [Stage 5](/en/stages/05-claude-code-ecosystem/), and [A3](/en/tracks/cli-a3-cli-production/); [Stage 8](/en/stages/08-agent-interfaces/) is recommended but does not block starting this path. Track B readers can start with [Stage 7](/en/stages/07-multi-agent-production/).
...
<tr><th scope="rowgroup" rowspan="6">Open-source Coding Agents／Harnesses</th><td><a href="https://github.com/anomalyco/opencode">anomalyco/opencode</a></td><td>coding agent／harness</td><td>terminal／desktop</td><td>Switch Provider or compatible endpoint</td><td>Active; MIT; V2 project rules use <code>AGENTS.md</code></td><td>⭐⭐⭐⭐⭐</td></tr>
...
Next stop: design Skills／MCP with [Stage 5](/en/stages/05-claude-code-ecosystem/); build Eval, Observability, and production gates with [Stage 7](/en/stages/07-multi-agent-production/); compare CLI agents in the [CLI agent guide](/en/resources/cli-agents-guide/).
