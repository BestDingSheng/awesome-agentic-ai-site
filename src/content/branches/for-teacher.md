---
title: "教師延伸路線（For Teachers / Educators）"
description: "AI 可以先做草稿，教師負責決定能不能用。這條路教你用 AI 準備教材、設計練習與整理回饋，同時保護學生資料，不把判斷交給機器。"
section: "Branch"
...
第一次來，先做本頁的小練習。你只需要一個**學校核准的 AI 工具**；不需要先學程式。想做大量自動化時，再走 [Track A](/zh-tw/tracks/cli-a1-cli-intro/)。
...
![教師把關 AI 教材的五步循環](/upstream/resources/diagrams/teacher-ai-review-loop.png)
...
下一站：做日常自動化可走 [Track A](/zh-tw/tracks/cli-a1-cli-intro/)；自己建立教學 Agent 可走 [Stage 3](/zh-tw/stages/03-tool-use-and-hello-agent/)；要做教材知識庫可走 [Stage 6](/zh-tw/stages/06-memory-rag/)；也做研究則看 [研究人員路線](/zh-tw/branches/for-researcher/)。
...
- 每週重跑相同流程：讀 [Track A](/zh-tw/tracks/cli-a1-cli-intro/)，但先和校方 IT 確認帳號、權限與資料邊界。
...
![教師與 AI agent 使用情境總覽](/upstream/resources/diagrams/teacher-ai-use-cases-overview.png)
...
- 課程 Agent：先完成 [Stage 3](/zh-tw/stages/03-tool-use-and-hello-agent/)，再加工具；不要一開始就接 LMS 寫入權限。
- 私有教材知識庫：看 [Stage 6](/zh-tw/stages/06-memory-rag/)，並先確認教材授權、保存位置與刪除方式。
