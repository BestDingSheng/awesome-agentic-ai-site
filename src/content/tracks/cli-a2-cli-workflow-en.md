---
title: "A2 — Make CLI agents follow the same method every time"
description: "This stop answers one question: How do you make a CLI agent remember the same way of working when it enters the same repo next time?"
section: "Track"
...
- **Prerequisites**: Complete [A1](/en/tracks/cli-a1-cli-intro/), know how to use `git status` and `git diff`, and have a secret-free, recoverable demo repo.
...
The complete subagent, agent team, background-work, and review processes are in [Stage 5.5](/en/stages/05-claude-code-ecosystem/#55--subagents-claude-codes-native-multi-agent-mechanism--2025-new-feature). A2 only practices making the work clear.
</details>
