...
syncedAt: "2026-05-14T14:23:36.178Z"
language: "zh-tw"
languageLabel: "繁體中文"
...
> 🔑 **關鍵名詞**：見 [`resources/glossary.md` §5 + §6](/zh-tw/resources/glossary/#5-claude-code-生態)（MCP / observability / eval / prompt caching / cost tracking）
...
照 [Stage 5.2 練習：MCP client](/zh-tw/stages/05-claude-code-ecosystem/#hello-x) 的步驟，把至少一個有用的 MCP server 接到你的 CLI：
...
| | [promptfoo/promptfoo](https://github.com/promptfoo/promptfoo) | ⭐⭐⭐⭐⭐ | CLI workflow 升 production 前跑回歸測試 | eval framework，★ 20k+。詳見 [Stage 7 §Agent Benchmark Landscape + Reward-Hacking 警告](/zh-tw/stages/07-multi-agent-production/#-agent-benchmark-landscape2026-05-最新--reward-hacking-警告) |
...
如果都可以 → **Track A 完整通關**。挑一個 [specialized branch](/zh-tw#️-學習地圖兩條軌道) 繼續走（researcher / developer / teacher / knowledge-worker / everyday-users）。
