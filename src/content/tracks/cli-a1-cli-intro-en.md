...
| | [Ollama](https://github.com/ollama/ollama) | ⭐⭐⭐⭐⭐ | Wanting a local LLM for your CLI agent to use | Local LLM runner, pairs with OpenCode / goose, or any tool taking an OpenAI-compatible base_url (★ 170k+). See [Stage 1 — Local LLM section](/en/stages/01-llm-basics/#exercise-6-local-llm) |
