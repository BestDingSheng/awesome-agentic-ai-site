...
> [← Back to the main path README](/en) · **Track A: CLI Power User** — Stop 1 · [Next: A2](/en/tracks/cli-a2-cli-workflow/)
...
A1 teaches you how to start safely; it does not maintain the same fast-changing data in two pages. Sign-in, provider, sandbox, and official sources for the 9 tools are centralized in the [`CLI Agents reference guide`](/en/resources/cli-agents-guide/). Official data checked on: **2026-08-30 UTC**.
...
After that, continue to [A2 — Build a reusable CLI workflow](/en/tracks/cli-a2-cli-workflow/). To compare the tools’ official status again, return to [`resources/cli-agents-guide.en.md`](/en/resources/cli-agents-guide/).
