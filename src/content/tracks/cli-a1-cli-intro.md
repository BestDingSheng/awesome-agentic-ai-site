...
> [← 回主路線 README](/zh-tw) · **Track A: CLI Power User** 第 1 站 · [下一站：A2](/zh-tw/tracks/cli-a2-cli-workflow/)
...
A1 只教你安全開始，不在兩個頁面重複維護同一份易變資料。9 個工具的登入、provider、sandbox 與官方來源集中放在 [`CLI Agents 參考指南`](/zh-tw/resources/cli-agents-guide/)。官方資料查核日：**2026-08-30 UTC**。
...
完成後進入 [A2 — 建立可重複使用的 CLI 工作流程](/zh-tw/tracks/cli-a2-cli-workflow/)。想再比較工具的官方狀態，回看 [`resources/cli-agents-guide.md`](/zh-tw/resources/cli-agents-guide/)。
