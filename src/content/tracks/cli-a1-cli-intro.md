...
| | [Ollama](https://github.com/ollama/ollama) | ⭐⭐⭐⭐⭐ | 想本機跑 LLM 給 CLI agent 用 | 本地 LLM runner、跟 OpenCode / goose 搭配（也能單獨提供 OpenAI-compatible API），★ 170k+。詳見 [Stage 1 — Local LLM 執行](/zh-tw/stages/01-llm-basics/#練習-6local-llm) |
