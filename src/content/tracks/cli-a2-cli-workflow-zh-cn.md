...
4. [**`resources/cli-agents-guide.zh-CN.md`** §“跨 CLI 都通用的 prompt 写法”](/resources/cli-agents-guide/) — portable prompt 原则
...
#### [`resources/cli-agents-guide.zh-CN.md`](/resources/cli-agents-guide/) §“3 个常见搭配”
