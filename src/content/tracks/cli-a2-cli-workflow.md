---
title: "A2 — 讓 CLI agent 每次都照同一套方法做事"
description: "這一站只解決一個問題：怎麼讓 CLI agent 下次進到同一個 repo，還記得同一套做事方法？"
section: "Track"
...
- **先備條件**：完成 [A1](/zh-tw/tracks/cli-a1-cli-intro/)，會看 `git status`、`git diff`，並有一個不含秘密、可復原的 demo repo。
...
完整的 subagent、agent team、背景工作與審查流程放在 [Stage 5.5](/zh-tw/stages/05-claude-code-ecosystem/#55--subagentsclaude-code-原生-multi-agent-機制-2025-新功能)。A2 只練習把工作切清楚。
</details>
