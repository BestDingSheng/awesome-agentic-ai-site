...
> [← 回主线路 README](/) · **Track A: CLI Power User** 第 1 站 · [下一站：A2](/tracks/cli-a2-cli-workflow/)
...
A1 只教你安全开始，不在两个页面重复维护同一份易变数据。9 个工具的登录、provider、sandbox 和官方来源集中放在 [`CLI Agents 参考指南`](/resources/cli-agents-guide/)。官方资料查核日：**2026-08-30 UTC**。
...
完成后进入 [A2 — 建立可重复使用的 CLI 工作流程](/tracks/cli-a2-cli-workflow/)。想再比较工具的官方状态，回看 [`resources/cli-agents-guide.zh-Hans.md`](/resources/cli-agents-guide/)。
